...
INSERT INTO `caixa` VALUES (1,6,1525.00),(2,7,100.00),(3,4,0.00),(4,8,2973.91),(5,1,0.00),(6,9,0.00),(7,2,3236.81),(8,3,335.00);
...
INSERT INTO `timeline` VALUES (1,'CADASTROCLIENTE','SIMPLES','fa fa-user bg-aqua','Novo Cliente!','Teste da Silva é nosso mais novo cliente.','2018-04-06 10:39:21'),(2,'CADASTROCLIENTE','SIMPLES','fa fa-user bg-aqua','Novo Cliente!','João da Silva é nosso mais novo cliente.','2018-04-06 11:11:23'),(3,'CADASTROCLIENTE','SIMPLES','fa fa-user bg-aqua','Novo Cliente!','Eduarda Meins Graeff é nosso mais novo cliente.','2018-04-06 14:57:47'),(4,'CADASTROCLIENTE','SIMPLES','fa fa-user bg-aqua','Novo Cliente!','Teste Teste de Oliveira é nosso(a) mais novo(a) cliente.','2018-04-06 16:29:06'),(5,'CADASTROCLIENTE','SIMPLES','fa fa-user bg-aqua','Novo Cliente!','Xxxxxxxxxxxxxxxxx é nosso(a) mais novo(a) cliente.','2018-04-06 16:41:28'),(6,'CADASTROCLIENTE','SIMPLES','fa fa-user bg-aqua','Novo Cliente!','zzzzzzzzzzzzzz é nosso(a) mais novo(a) cliente.','2018-04-07 16:53:29'),(7,'CADASTROPRODUTO','SIMPLES','fa fa-tv bg-yellow','Novo Produto!','Video Game | Microsoft | XBox One 500GB foi adicionado ao catálogo de produtos.','2018-04-07 14:49:24');
...
-- Dump completed on 2018-04-07 16:01:48
